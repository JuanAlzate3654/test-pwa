...
import { routeEvidenceEditSchema } from "@components/route/routeEvidenceEdit/_redux/model";
import type { RouteEvidenceEditStateModel } from "@components/route/routeEvidenceEdit/_redux/routeEvidenceEditReducer";
...
export default function RouteEvidenceEdit() {
    ...
    const handleDeleteEvidence = (index: number) => {
        ...
        void formik.setFieldValue("evidences", updatedEvidences);
    }
