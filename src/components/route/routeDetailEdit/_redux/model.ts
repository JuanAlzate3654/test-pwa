...
export const routeDetailEditSchema = yup.object().shape({
    ...
    direccionEncasillada: yup.string().required(t("route_detail_edit_direccion_encasillada_required")),
    ...
    bitacoraActividades: yup.array().of(yup.string().oneOf(["VISITADA", "EVIDENCIA", "ENCUESTA"])).required(t("route_detail_edit_bitacora_actividades_required")),
