...
import { RouteDetailEditService } from "@components/route/routeDetailEdit/_redux/RouteDetailEditService";
...
export function* findOneSaga(action: PayloadAction<{ id: string }>) {
    try {
        ...
        yield put(
            routeDetailEditSlice.actions.findOneSuccessReducer(response.data)
        );
    } catch (e) {
